...
define('THEMEHUNK_THEME_NAME',esc_html__( 'Jot Shop', 'themhunk' ));
...
if ( ! defined( 'THEMEHUNK_SITE_LIBRARY_DIR' ) ) {
	define( 'THEMEHUNK_SITE_LIBRARY_DIR', JOT_SHOP_THEME_DIR.'/import/' );
}

if ( ! defined( 'THEMEHUNK_SITE_LIBRARY_URI' ) ) {
	define( 'THEMEHUNK_SITE_LIBRARY_URI', JOT_SHOP_THEME_DIR.'/import/' );
}
