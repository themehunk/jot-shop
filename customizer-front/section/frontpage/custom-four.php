 ...
 */
$wp_customize->add_setting( 'jot_shop_custom_section4_hide',
                array(
                    'default'  => '1',
                    'sanitize_callback' => 'jot_shop_sanitize_checkbox',
                 ));
$wp_customize->add_control( 'jot_shop_custom_section4_hide',
                array(
                    'type'        => 'checkbox',
                    'label'       => esc_html__('Disable section', 'jot-shop'),
                    'priority'   => 1,
                    'section'     => 'jot_shop_4_custom_sec',
                ));
$wp_customize->add_setting('jot_shop_custom_4_heading', 
      array(
        'default' => __('Fourth Custom Section', 'jot-shop'),
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'jot_shop_sanitize_text',
        'transport'         => 'postMessage',
));
    $wp_customize->add_control( 'jot_shop_custom_4_heading', 
    array(
        'label'    => __('Fourth Custom Section', 'jot-shop'),
        'section'  => 'jot_shop_4_custom_sec',
         'type'       => 'text',
));
...
if(class_exists('Jot_Shop_WP_Customize_Control_Radio_Image')){
               ...
               'jot_shop_custom_section4_widget_layout', array(
               'default'           => 'cs-4-1',
...
$wp_customize->add_control(
            new  Jot_Shop_WP_Customize_Control_Radio_Image(
                $wp_customize, 'jot_shop_custom_section4_widget_layout', array(
...
$wp_customize->add_setting(
            'jot_shop_custom_section4_widget_redirect', array(
            'sanitize_callback' => 'sanitize_text_field',
     )
);
$wp_customize->add_control(
            new Jot_Shop_Widegt_Redirect(
                $wp_customize, 'jot_shop_custom_section4_widget_redirect', array(
                    'section'      => 'jot_shop_4_custom_sec',
