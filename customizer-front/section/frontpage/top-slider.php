 ...
 */
    ...
    $wp_customize->add_control(new Jot_Shop_Customize_Sort_List(
         $wp_customize,'_sorting', array(
        'settings' => '_sorting',
        'label'   => __( 'Section Ordering', 'jot-shop' ),
        'section' => 'jot-shop-section-order',
        'choices' => array(
                'topslider'        => __( 'Top Slider','jot-shop' ),
                'categoryslider'   => __( 'Woo Category','jot-shop' ),
                'productslider'    => __( 'Product Carousel','jot-shop' ),
                'tabproduct'       => __( 'Tabbed Product Carousel','jot-shop' ),
                'productlist'      => __( 'Product List Carousel','jot-shop' ),
                'tabproductlist'   => __( 'Tabbed Product List Carousel','jot-shop' ),
                'banner'           => __( 'Banner','jot-shop' ),
                'ribbon'           => __( 'Ribbon','jot-shop' ),
                'brand'            => __( 'Brand','jot-shop'),                    
                'highlight'        => __( 'Highlight','jot-shop' ),
                'tabproductimage'   => __( 'Tabbed Product Image','jot-shop' ), 
                'featureproduct'   => __( 'Big Featured Product','jot-shop' ), 
                'customone'        => __( 'First Custom Section','jot-shop' ),
                'customtwo'        => __( 'Second Custom Section','jot-shop' ),  
                'customthree'      => __( 'Third Custom Section','jot-shop' ),
                'customfour'       => __( 'Fourth Custom Section','jot-shop' ),  
            )
        ) 
    )
);  

    $wp_customize->add_setting('jot_shop_section_ordering_doc', array(
    'sanitize_callback' => 'jot_shop_sanitize_text',
    ));
    $wp_customize->add_control(new Jot_Shop_Misc_Control( $wp_customize, 'jot_shop_section_ordering_doc',
            array(
        'section'     => 'jot-shop-section-order',
        'type'        => 'doc-link',
        'url'         => 'https://themehunk.com/docs/jot-shop-pro/#section-ordering',
        'description' => esc_html__( 'To know more go with this', 'jot-shop' ),
        'priority'   =>100,
    )));