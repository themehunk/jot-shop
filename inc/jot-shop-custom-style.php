...
// Slider BG 
  ...
  /**************************/
   $jot_shop_above_hd_bg_clr = esc_html(get_theme_mod('jot_shop_above_hd_bg_clr','#1f4c94'));
  ...
  /**************************/
   $jot_shop_below_hd_bg_clr = esc_html(get_theme_mod('jot_shop_below_hd_bg_clr','#1f4c94'));
  ...
  /**************************/
   $jot_shop_sq_icon_bg_clr = esc_html(get_theme_mod('jot_shop_sq_icon_bg_clr','#1f4c94'));
   $jot_shop_sq_icon_clr = esc_html(get_theme_mod('jot_shop_sq_icon_clr','#fff'));
