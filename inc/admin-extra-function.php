 ...
 */
function jot_shop_display_color_customizer_shortcut( $class_name ){
 ...
 */
if ( ! function_exists( 'jot_shop_custom_one_markup' ) ){  
function jot_shop_custom_one_markup(){ ?>
<?php 
$jot_shop_custom_section1_widget_layout  = get_theme_mod( 'jot_shop_custom_section1_widget_layout','cs-1-1');
?>  
<div class="widget-cs">
      <div class="widget-cs-bar <?php echo esc_attr($jot_shop_custom_section1_widget_layout);?>">
           
            <div class="widget-cs-container">
              <?php if($jot_shop_custom_section1_widget_layout=='cs-1-1'):?>
                 <div class="widget-cs-col1">
                  <?php if( is_active_sidebar('first-customsec-1' ) ){
                      ...
                      <?php elseif($jot_shop_custom_section1_widget_layout=='cs-1-2'): ?>
                        <div class="widget-cs-col1">
                  <?php if( is_active_sidebar('first-customsec-1' ) ){
                                       dynamic_sidebar('first-customsec-1' );
                             }else{?>
                 ...
                 <div class="widget-cs-col2"><?php if( is_active_sidebar('first-customsec-2' ) ){
                      ...
                      <?php elseif($jot_shop_custom_section1_widget_layout=='cs-1-3'): ?>
                        <div class="widget-cs-col1">
                  <?php if( is_active_sidebar('first-customsec-1' ) ){
                                       dynamic_sidebar('first-customsec-1' );
                             }else{?>
                 ...
                 <div class="widget-cs-col3"><?php if( is_active_sidebar('first-customsec-3' ) ){
                       ...
                       <?php elseif($jot_shop_custom_section1_widget_layout=='cs-1-4'): ?>
                        <div class="widget-cs-col1">
                  <?php if( is_active_sidebar('first-customsec-1' ) ){
                                       dynamic_sidebar('first-customsec-1' );
                             }else{?>
 ...
 * Function to get custom section widget
 */
if ( ! function_exists( 'jot_shop_custom_two_markup' ) ){  
function jot_shop_custom_two_markup(){ ?>
<?php 
$jot_shop_custom_section2_widget_layout  = get_theme_mod( 'jot_shop_custom_section2_widget_layout','cs-2-1');
?>  
<div class="widget-cs">
      <div class="widget-cs-bar <?php echo esc_attr($jot_shop_custom_section2_widget_layout);?>">
           
            <div class="widget-cs-container">
              <?php if($jot_shop_custom_section2_widget_layout=='cs-2-1'):?>
                 <div class="widget-cs-col1">
                  <?php if( is_active_sidebar('second-customsec-1' ) ){
                      ...
                      <?php elseif($jot_shop_custom_section2_widget_layout=='cs-2-2'): ?>
                        <div class="widget-cs-col1">
                  <?php if( is_active_sidebar('second-customsec-1' ) ){
                                       dynamic_sidebar('second-customsec-1' );
                             }else{?>
                 ...
                 <div class="widget-cs-col2"><?php if( is_active_sidebar('second-customsec-2' ) ){
                      ...
                      <?php elseif($jot_shop_custom_section2_widget_layout=='cs-2-3'): ?>
                        <div class="widget-cs-col1">
                  <?php if( is_active_sidebar('second-customsec-1' ) ){
                                       dynamic_sidebar('second-customsec-1' );
                             }else{?>
                 ...
                 <div class="widget-cs-col3"><?php if( is_active_sidebar('second-customsec-3' ) ){
                      ...
                      <?php elseif($jot_shop_custom_section2_widget_layout=='cs-2-4'): ?>
                        <div class="widget-cs-col1">
                  <?php if( is_active_sidebar('second-customsec-1' ) ){
                                       dynamic_sidebar('second-customsec-1' );
                             }else{?>
 ...
 * Function to get custom section widget
 */
if ( ! function_exists( 'jot_shop_custom_three_markup' ) ){  
function jot_shop_custom_three_markup(){ ?>
<?php 
$jot_shop_custom_section3_widget_layout  = get_theme_mod( 'jot_shop_custom_section3_widget_layout','cs-3-1');
?>  
<div class="widget-cs">
      <div class="widget-cs-bar <?php echo esc_attr($jot_shop_custom_section3_widget_layout);?>">
           
            <div class="widget-cs-container">
              <?php if($jot_shop_custom_section3_widget_layout=='cs-3-1'):?>
                 <div class="widget-cs-col1">
                  <?php if( is_active_sidebar('third-customsec-1' ) ){
                      ...
                      <?php elseif($jot_shop_custom_section3_widget_layout=='cs-3-2'): ?>
                        <div class="widget-cs-col1">
                  <?php if( is_active_sidebar('third-customsec-1' ) ){
                                       dynamic_sidebar('third-customsec-1' );
                             }else{?>
                 ...
                 <div class="widget-cs-col2"><?php if( is_active_sidebar('third-customsec-2' ) ){
                      ...
                      <?php elseif($jot_shop_custom_section3_widget_layout=='cs-3-3'): ?>
                        <div class="widget-cs-col1">
                  <?php if( is_active_sidebar('third-customsec-1' ) ){
                                       dynamic_sidebar('third-customsec-1' );
                             }else{?>
                 ...
                 <div class="widget-cs-col3"><?php if( is_active_sidebar('third-customsec-3' ) ){
                      ...
                      <?php elseif($jot_shop_custom_section3_widget_layout=='cs-3-4'): ?>
                        <div class="widget-cs-col1">
                  <?php if( is_active_sidebar('third-customsec-1' ) ){
                                       dynamic_sidebar('third-customsec-1' );
                             }else{?>
 ...
 * Function to get custom section widget
 */
if ( ! function_exists( 'jot_shop_custom_four_markup' ) ){ 
function jot_shop_custom_four_markup(){ ?>
<?php 
$jot_shop_custom_section4_widget_layout  = get_theme_mod( 'jot_shop_custom_section4_widget_layout','cs-4-1');
?>  
<div class="widget-cs">
      <div class="widget-cs-bar <?php echo esc_attr($jot_shop_custom_section4_widget_layout);?>">
           
            <div class="widget-cs-container">
              <?php if($jot_shop_custom_section4_widget_layout=='cs-4-1'):?>
                 <div class="widget-cs-col1">
                  <?php if( is_active_sidebar('four-customsec-1' ) ){
                      ...
                      <?php elseif($jot_shop_custom_section4_widget_layout=='cs-4-2'): ?>
                        <div class="widget-cs-col1">
                  <?php if( is_active_sidebar('four-customsec-1' ) ){
                                       dynamic_sidebar('four-customsec-1' );
                             }else{?>
                 ...
                 <div class="widget-cs-col2"><?php if( is_active_sidebar('four-customsec-2' ) ){
                      ...
                      <?php elseif($jot_shop_custom_section4_widget_layout=='cs-4-3'): ?>
                        <div class="widget-cs-col1">
                  <?php if( is_active_sidebar('four-customsec-1' ) ){
                                       dynamic_sidebar('four-customsec-1' );
                             }else{?>
                 ...
                 <div class="widget-cs-col3"><?php if( is_active_sidebar('four-customsec-3' ) ){
                      ...
                      <?php elseif($jot_shop_custom_section4_widget_layout=='cs-4-4'): ?>
                        <div class="widget-cs-col1">
                  <?php if( is_active_sidebar('four-customsec-1' ) ){
                                       dynamic_sidebar('four-customsec-1' );
                             }else{?>
