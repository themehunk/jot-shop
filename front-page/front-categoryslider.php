...
<section class="thunk-category-slide-section">
      ...
      jot_shop_display_color_customizer_shortcut('jot-shop-cat-slider-color');?>
  <div class="thunk-heading-wrap">
  <div class="thunk-heading">
    <h4 class="thunk-title">
    <span class="title"><?php echo esc_html(get_theme_mod('jot_shop_cat_slider_heading','Category Slider'));?></span>
   </h4>
</div>
</div>
