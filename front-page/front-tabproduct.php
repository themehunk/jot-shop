...
jot_shop_display_color_customizer_shortcut( 'jot-shop-product-cat-slide-tab-color' );?>
 ...
 <!-- thunk head start -->
  ...
  <div class="thunk-heading">
    ...
    <span class="title"><?php echo esc_html(get_theme_mod('jot_shop_cat_tab_heading','Big Featured Slider'));?></span>
   </h4>
  </div>
<!-- tab head start -->
