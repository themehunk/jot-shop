...
<section class="thunk-product-slide-section">
    <?php jot_shop_display_customizer_shortcut( 'jot_shop_product_slide_section' );jot_shop_display_color_customizer_shortcut( 'jot-shop-product-slider-color' );?>
  <div class="thunk-heading-wrap">
  <div class="thunk-heading">
    <h4 class="thunk-title">
    <span class="title"><?php echo esc_html(get_theme_mod('jot_shop_product_slider_heading','Product Slider'));?></span>
   </h4>
</div>
</div>
