...
?>
<section class="thunk-slider-section   <?php echo esc_attr(get_theme_mod('jot_shop_top_slide_layout','slide-layout-1'));?>">
  
<?php 

if(get_theme_mod('jot_shop_top_slide_layout','slide-layout-3')=='slide-layout-3'):
?>
  <?php jot_shop_display_customizer_shortcut( 'jot_shop_top_slider_section' );
jot_shop_display_color_customizer_shortcut('jot-shop-top-slider-color');?>
 ...
 <?php elseif(get_theme_mod('jot_shop_top_slide_layout','slide-layout-4')=='slide-layout-4'):?>
 <div class="thunk-slider-content-wrap">
        <div class="thunk-slider-content-bar">
 ...
 <?php elseif(get_theme_mod('jot_shop_top_slide_layout','slide-layout-2')=='slide-layout-2'):?>
 <div class="thunk-slider-content-wrap">
        <div class="thunk-slider-content-bar">
  ...
  <?php elseif(get_theme_mod('jot_shop_top_slide_layout','slide-layout-1')=='slide-layout-1'):?>
 <div class="thunk-slider-content-wrap">
  ...
  <?php elseif(get_theme_mod('jot_shop_top_slide_layout','slide-layout-6')=='slide-layout-6'):?>
 <div class="thunk-slider-content-wrap">
   ...
   <?php elseif(get_theme_mod('jot_shop_top_slide_layout','slide-layout-9')=='slide-layout-9'):?>
 <div class="thunk-slider-content-wrap">
