...
<section class="thunk-product-list-section">
        ...
        jot_shop_display_color_customizer_shortcut( 'jot-shop-product-list-slide-color' );?>
  <div class="thunk-heading-wrap">
  <div class="thunk-heading">
    <h4 class="thunk-title">
    <span class="title"><?php echo esc_html(get_theme_mod('jot_shop_product_list_heading','Product Slider'));?></span>
   </h4>
</div>
</div>
